...
The Daemon is the remote agent component of Codecast. It runs on each remote machine (GPU server, cloud VM, etc.) and provides a JSON-RPC interface for managing Claude CLI sessions.
...
| `HOME` | System default | Used to locate the skills source directory (`~/.codecast/skills`) |
